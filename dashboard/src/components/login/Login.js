    ...
    <div className="login-wrap">
      ...
      <Row className="row align-items-center left-inner-wrap">
        ...
        <Col md={6} className="login-left">
          ...
          <h4 className="login-header">Welcome Admin !</h4>

          <h6 className="login-header">Use the provided login or login with your Company Google account.</h6>
          ...
          <h6 className="login-header">Don't have an account? Contact your administrator and then Register your personal email here!</h6>
